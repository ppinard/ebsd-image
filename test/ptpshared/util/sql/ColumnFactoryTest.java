...
public class ColumnFactoryTest {
    ...
    public void testColumnFloat() {
        Column column =
                ColumnFactory.columnFloat("col1", false, true, false, 0.0f);
    ...
    public void testColumnInteger() {
        Column column =
                ColumnFactory.columnInteger("col1", true, false, false, true,
                        true);
    ...
    public void testColumnTinyInt() {
        Column column =
                ColumnFactory.columnTinyInt("col1", true, 0, false, false);
