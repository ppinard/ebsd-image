...
public class ColumnTest {
  ...
  public void setUp() throws Exception {
    ...
    column1 =
        new Column(ColumnType.TEXT, "col1.test", false, false, false, "NULL",
            false, false);
    column2 =
        new Column(ColumnType.FLOAT, "col2/test", true, true, true, true, true);
  }
  ...
  public void testColumnColumnTypeStringBooleanBooleanBooleanBooleanBoolean() {
    ...
    assertEquals("col2_test FLOAT UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT",
        column2.command);
  }
