...
public class PeaksCountTest {

    private PeaksCount peaksCount;
    ...
    public void testCalculate() {
        ...
        OpResult result = peaksCount.calculate(null, peaks)[0];
    ...
    public void testToString() {
        assertEquals(peaksCount.toString(), "Peaks Count");
    }
