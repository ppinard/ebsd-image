...
public class PositioningPreOpsMockTest extends TestCase {

    private PositioningPreOpsMock op;
    ...
    public void testXML() throws Exception {
        ...
        PositioningPreOpsMock other =
                new XmlLoader().load(PositioningPreOpsMock.class, file);
