...
public class PatternBandCenterTest extends TestCase {
    ...
    private PatternBandCenter pattern;
    ...
    public void setUp() throws Exception {
        ...
        pattern =
                new PatternBandCenter(336, 256, reflectors, -1, camera, energy,
                        rotation);
    }
    ...
    @Test
    public void testPatternBandCenterIntIntReflectorsIntCameraEnergyEulers() {
    ...
    @Test
    public void testPatternBandCenterIntIntReflectorsIntCameraEnergyQuaternion() {
        Quaternion quaternion = new Quaternion(rotation);
        PatternBandCenter other =
                new PatternBandCenter(336, 256, reflectors, 5, camera, energy,
                        quaternion);
