...
public class PatternFilledBandTest extends TestCase {
    ...
    private PatternFilledBand pattern;
    ...
    public void setUp() throws Exception {
        ...
        pattern =
                new PatternFilledBand(336, 256, reflectors, -1, camera, energy,
                        rotation);
    }
    ...
    @Test
    public void testPatternFilledBandIntIntReflectorsIntCameraDoubleEulers() {
    ...
    @Test
    public void testPatternFilledBandIntIntIntCameraDoubleQuaternion() {
        Quaternion quaternion = new Quaternion(rotation);
        PatternFilledBand pattern =
                new PatternFilledBand(336, 256, reflectors, 5, camera, energy,
                        quaternion);

        assertEquals(336, pattern.width);
        assertEquals(256, pattern.height);
        assertEquals(5, pattern.numberReflectors);
        assertTrue(energy.equals(pattern.energy, 1e-6));
        assertTrue(camera.equals(pattern.camera, 1e-6));
        assertTrue(quaternion.equals(pattern.rotation, 1e-6));
    }
