...
public class AngLoaderHexGridTest extends TslMMapTester {

    private File file;



    public AngLoaderHexGridTest() throws Exception {
        file = getFile("org/ebsdimage/vendors/tsl/testdata/scan2.ang");
