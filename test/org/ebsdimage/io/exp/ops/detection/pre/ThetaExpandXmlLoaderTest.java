...
public class ThetaExpandXmlLoaderTest {
    ...
    public void setUp() throws Exception {
        ...
        element.setAttribute(ATTR_INCREMENT, Double.toString(1.5));
    }
    ...
    public void testLoad() {
        ThetaExpand op = new ThetaExpandXmlLoader().load(element);

        assertEquals(TAG_NAME, op.getName());
        assertEquals(1.5, op.increment, 1e-6);
    }
