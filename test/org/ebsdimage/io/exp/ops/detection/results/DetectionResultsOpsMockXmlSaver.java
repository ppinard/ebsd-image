...
public class DetectionResultsOpsMockXmlSaver implements ObjectXmlSaver {

    @Override
    public Element save(ObjectXml obj) {
        return save((DetectionResultsOpsMock) obj);
    }



    public Element save(DetectionResultsOpsMock obj) {
