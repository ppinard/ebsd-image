...
public class PatternPostOps2MockXmlSaver implements ObjectXmlSaver {

    @Override
    public Element save(ObjectXml obj) {
        return save((PatternPostOps2Mock) obj);
    }



    public Element save(PatternPostOps2Mock obj) {
        Element element = new Element(TAG_NAME);

        element.setAttribute(ATTR_VAR, Integer.toString(obj.var));
