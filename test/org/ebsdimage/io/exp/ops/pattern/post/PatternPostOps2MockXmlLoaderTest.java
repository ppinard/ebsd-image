...
public class PatternPostOps2MockXmlLoaderTest {
    ...
    public void setUp() throws Exception {
        ...
        element.setAttribute(ATTR_VAR, Integer.toString(3));
    }
    ...
    public void testLoad() {
        Operation op = new PatternPostOps2MockXmlLoader().load(element);
