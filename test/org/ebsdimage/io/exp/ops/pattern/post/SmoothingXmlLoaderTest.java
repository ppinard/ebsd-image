...
import org.ebsdimage.io.exp.ops.pattern.post.SmoothingXmlLoader;
import org.jdom.Element;
import org.junit.Before;
import org.junit.Test;


public class SmoothingXmlLoaderTest {
    ...
    public void setUp() throws Exception {
        ...
        element.setAttribute(ATTR_KERNELSIZE, Integer.toString(3));
    }
    ...
    public void testLoad() {
        Smoothing op = new SmoothingXmlLoader().load(element);
