...
public class PatternFileLoaderXmlSaverTest {

    private PatternFileLoader op;
    ...
    public void setUp() throws Exception {
        ...
        op = new PatternFileLoader(45, filepath);
    }
    ...
    public void testSavePatternFileLoader() {
        Element element = new PatternFileLoaderXmlSaver().save(op);
