...
public class DoublePeaksCleanUpXmlLoaderTest {
    ...
    public void setUp() throws Exception {
        ...
        element.setAttribute(ATTR_SPACING_RHO, Integer.toString(2));
        element.setAttribute(ATTR_SPACING_THETA, Integer.toString(3));
    }
    ...
    public void testLoad() {
        DoublePeaksCleanUp op = new DoublePeaksCleanUpXmlLoader().load(element);
