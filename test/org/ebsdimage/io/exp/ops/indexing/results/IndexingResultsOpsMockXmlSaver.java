...
public class IndexingResultsOpsMockXmlSaver implements ObjectXmlSaver {

    @Override
    public Element save(ObjectXml obj) {
        return save((IndexingResultsOpsMock) obj);
    }



    public Element save(IndexingResultsOpsMock obj) {
