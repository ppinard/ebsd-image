...
import static org.ebsdimage.io.sim.ops.patternsim.PatternBandCenterXmlTags.TAG_NAME;
...
public class PatternBandCenterXmlSaverTest {
    ...
    public void setUp() throws Exception {
        op = new PatternBandCenter(336, 256, 5, ScatteringFactorsEnum.XRAY);
    }



    @Test
    public void testSavePatternBandCenterXrayScatter() {
        Element element = new PatternBandCenterXmlSaver().save(op);
