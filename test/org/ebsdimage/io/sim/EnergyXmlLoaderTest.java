...
import org.ebsdimage.io.sim.EnergyXmlLoader;
import org.jdom.Element;
import org.junit.Before;
import org.junit.Test;


public class EnergyXmlLoaderTest {
    ...
    public void setUp() throws Exception {
        ...
        element.setAttribute(ATTR_VALUE, Double.toString(20e3));
    }
    ...
    public void testLoad() {
        Energy energy = new EnergyXmlLoader().load(element);

        assertEquals(20e3, energy.value, 1e-7);
    }
