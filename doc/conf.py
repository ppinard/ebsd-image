...
project = u'EBSD-Image'
copyright = u'2011, Philippe T. Pinard'
...
htmlhelp_basename = 'ebsdimagedoc'
...
latex_documents = [
  ('index', 'ebsdimage.tex', u'EBSD-Image Documentation',
   u'Philippe T. Pinard', 'manual'),
]
