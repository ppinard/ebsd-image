...
/**
 * Wizard page to create phases based on the information in the ctf file.
 * 
...
public class PhasesWizardPage extends org.ebsdimage.gui.PhasesWizardPage {
    ...
    /** Field for the description of phases in the ctf file. */
    ...
    protected void renderingPage() {
        ...
        desc.append(phasesCount + " phase(s) need(s) to be defined. "
                + "In the ctf file, the following names "
