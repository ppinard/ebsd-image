...
/**
 * Operation to calculate the average quality index.
 * 
...
public class Average extends PatternResultsOps {
     ...
     * @param srcMap
     *            source map
     * @return one entry with the average quality index
     * 
     * @see QualityIndex#average(ByteMap)
     */
    @Override
    public OpResult[] calculate(Exp exp, ByteMap srcMap) {
        OpResult result =
                new OpResult(getName(), QualityIndex.average(srcMap),
                        RealMap.class);
