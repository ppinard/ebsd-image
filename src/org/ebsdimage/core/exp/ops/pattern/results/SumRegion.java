 ...
 * @author ppinard
 */
public class SumRegion extends PatternResultsOps {
    ...
    /**
     * Creates a new <code>SumRegion</code> with the default values.
     */
    public SumRegion() {
    ...
    /**
     * Creates a new <code>SumRegion</code> with the specified values.
     * 
     * @param xmin
     *            lower x limit as a fraction of the image width
     * @param xmax
     ...
     */
    public SumRegion(double xmin, double ymin, double xmax, double ymax) {
        if (xmin < 0 || xmin > 1)
    ...
    public String toString() {
        return "AverageRegion [xmin=" + xmin + ", ymin=" + ymin + ", xmax="
                + xmax + ", ymax=" + ymax + "]";
    }
}
