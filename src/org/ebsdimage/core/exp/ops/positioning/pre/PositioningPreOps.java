...
/**
 * Superclass of operation to process the peaks map before the positioning
 * operation.
 * 
 * @author Philippe T. Pinard
 */
public abstract class PositioningPreOps extends ExpOperation {
    ...
    public final void fireExecuted(ExpListener listener, Exp exp, Object result) {
        listener.positioningPrePerformed(exp, this, (BinMap) result);
    }
