...
/**
 * Operation to calculate the average intensity of the Hough peaks.
 * 
 * @author Philippe T. Pinard
 */
public class Average extends PositioningResultsOps {
    ...
    /**
     * Calculates the average intensity of the Hough peaks.
     * 
     * @param exp
    ...
    public OpResult[] calculate(Exp exp, HoughPeak[] peaks) {
        ...
        if (peaks.length == 0)
            ...
            value = Stats.average(intensities);
        }

        String name = "Peaks Average [max=" + max + "]";
