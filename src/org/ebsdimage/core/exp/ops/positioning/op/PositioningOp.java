...
/**
 * Superclass of operation to perform the peak positioning from a peaks map.
 * 
 * @author Philippe T. Pinard
 */
public abstract class PositioningOp extends ExpOperation {
    ...
    public final void fireExecuted(ExpListener listener, Exp exp, Object result) {
        listener.positioningOpPerformed(exp, this, (HoughPeak[]) result);
    }
