 ...
 */
public class LocalCentroidAndIntensityCreator implements OperationCreator {
    ...
    public String getDescription() {
        return "Identifies the Hough peaks from a peaks map by calculating"
                ...
                + "peak is set as the intensity at the centroid.";
    }
    ...
    public String toString() {
        return "Local Centroid with Intensity at Centroid";
    }
