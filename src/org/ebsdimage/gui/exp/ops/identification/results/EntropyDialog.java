...
/**
 * GUI creator for the <code>Entropy</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class EntropyDialog extends OperationDialog {
    ...
    /**
     * Creates a new <code>EntropyDialog</code>.
     */
    ...
    public String getDescription() {
        return "Calculates the entropy between the Hough peaks' intensities.";
    }
