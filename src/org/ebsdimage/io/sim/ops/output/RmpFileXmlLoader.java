...
/**
 * XML loader for a <code>RmpFile</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class RmpFileXmlLoader implements ObjectXmlLoader {

    /**
     * Loads a <code>RmpFile</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return a <code>RmpFile</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public RmpFile load(Element element) {
