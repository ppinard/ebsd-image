...
/**
 * XML loader for an <code>XmlFile</code> operation.
 * 
 * @author Philippe T. Pinard
 * 
 */
public class XmlFileXmlLoader implements ObjectXmlLoader {

    /**
     * Loads an <code>XmlFile</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return an <code>XmlFile</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public XmlFile load(Element element) {
