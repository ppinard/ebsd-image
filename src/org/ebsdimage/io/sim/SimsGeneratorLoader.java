 ...
 */
public class SimsGeneratorLoader extends XmlLoader {

    @Override
    protected ObjectXmlLoader getXmlLoader() {
        return new SimsGeneratorXmlLoader();
    }



    @Override
    public SimsGenerator load(File file) throws IOException {
        return (SimsGenerator) super.load(file);
    }
