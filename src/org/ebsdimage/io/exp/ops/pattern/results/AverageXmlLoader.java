...
import static org.ebsdimage.io.exp.ops.pattern.results.AverageXmlTags.TAG_NAME;
...
/**
 * XML loader for an <code>Average</code> operation.
 * 
...
public class AverageXmlLoader implements ObjectXmlLoader {
    ...
    /**
     * Loads an <code>Average</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return an <code>Average</code> operation
