...
/**
 * XML loader for an <code>SNR</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class SNRXmlLoader implements ObjectXmlLoader {

    /**
     * Loads an <code>SNR</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return an <code>SNR</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public SNR load(Element element) {
