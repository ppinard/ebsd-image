...
/**
 * XML loader for a <code>DoublePeaksCleanUp</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class DoublePeaksCleanUpXmlLoader implements ObjectXmlLoader {
     ...
     * @return a <code>DoublePeaksCleanUp</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public DoublePeaksCleanUp load(Element element) {
        ...
        return new DoublePeaksCleanUp(spacingRho, spacingTheta);
    }
