...
import static org.ebsdimage.io.exp.ops.identification.results.EntropyXmlTags.ATTR_MAX;
import static org.ebsdimage.io.exp.ops.identification.results.EntropyXmlTags.TAG_NAME;
...
/**
 * XML loader for a <code>Entropy</code> operation.
 * 
...
public class EntropyXmlLoader implements ObjectXmlLoader {
    ...
    /**
     * Loads a <code>Entropy</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return a <code>Entropy</code> operation
