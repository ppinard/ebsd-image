...
public class FitXmlSaver implements ObjectXmlSaver {
    ...
    /**
     * Saves a <code>Fit</code> operation to an XML <code>Element</code>.
     * 
     * @param op
     *            a <code>Fit</code> operation
     * @return an XML <code>Element</code>
     */
    public Element save(Fit op) {
        Element element = new Element(TAG_NAME);

        element.setAttribute(ATTR_FILEPATH, op.filepath.getAbsolutePath());
