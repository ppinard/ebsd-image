...
/**
 * XML loader for a <code>Median</code> operation.
 * 
 * @author Philippe T. Pinard
 * 
 */
public class MedianXmlLoader implements ObjectXmlLoader {

    /**
     * Loads a <code>Median</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return a <code>Median</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public Median load(Element element) {
