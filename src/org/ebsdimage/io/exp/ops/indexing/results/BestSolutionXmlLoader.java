...
/**
 * XML loader for a <code>BestSolution</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class BestSolutionXmlLoader implements ObjectXmlLoader {

    /**
     * Loads a <code>BestSolution</code> operation from an XML
     * <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return a <code>BestSolution</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public BestSolution load(Element element) {
