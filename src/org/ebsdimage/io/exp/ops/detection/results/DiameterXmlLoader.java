...
/**
 * XML loader for a <code>Diameter</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class DiameterXmlLoader implements ObjectXmlLoader {

    /**
     * Loads a <code>Diameter</code> operation from an XML <code>Element</code>.
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return a <code>Diameter</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public Diameter load(Element element) {
