...
/**
 * XML loader for a <code>Opening</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class OpeningXmlLoader implements ObjectXmlLoader {

    /**
     * Loads an <code>Opening</code> operation from an XML <code>Element</code>
     * .
     * 
     * @param element
     *            an XML <code>Element</code>
     * @return an <code>Opening</code> operation
     * @throws IllegalNameException
     *             if the <code>Element</code> tag name is incorrect.
     */
    @Override
    public Opening load(Element element) {
