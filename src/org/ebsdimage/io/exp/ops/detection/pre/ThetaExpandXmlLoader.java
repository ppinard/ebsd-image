...
/**
 * XML loader for a <code>ThetaExpand</code> operation.
 * 
 * @author Philippe T. Pinard
 */
public class ThetaExpandXmlLoader implements ObjectXmlLoader {
     ...
     */
    @Override
    public ThetaExpand load(Element element) {
        ...
        double increment =
                (float) JDomUtil.getDoubleFromAttribute(element,
                        ATTR_INCREMENT, ThetaExpand.DEFAULT_INCREMENT);

        return new ThetaExpand(increment);
    }
